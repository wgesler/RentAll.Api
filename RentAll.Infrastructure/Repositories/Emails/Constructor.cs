    ...
    public partial class EmailRepository : IEmailRepository
    {
        ...
        private EmailHtml ConvertEntityToModel(EmailHtmlEntity e)
        {
            return new EmailHtml
            {
                ...
                Schedules = e.Schedules ?? string.Empty,
                MissingReceipts = e.MissingReceipts ?? string.Empty,
                ...
                ScheduleSubject = e.ScheduleSubject ?? string.Empty,
                MissingReceiptsSubject = e.MissingReceiptsSubject ?? string.Empty,
                CreatedOn = e.CreatedOn,
                CreatedBy = e.CreatedBy,
                ModifiedOn = e.ModifiedOn,
                ModifiedBy = e.ModifiedBy
