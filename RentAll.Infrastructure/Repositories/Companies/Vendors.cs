...
namespace RentAll.Infrastructure.Repositories.Companies
{
    ...
    {
        #region Selects
        public async Task<IEnumerable<Vendor>> GetVendorsByOfficeIdsAsync(Guid organizationId, string officeAccess)
        {
        ...
        public async Task<Vendor?> GetVendorByVendorCodeAsync(string vendorCode, Guid organizationId)
        {
            await using var db = new SqlConnection(_dbConnectionString);
