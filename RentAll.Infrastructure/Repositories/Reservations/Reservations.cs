    ...
    public partial class ReservationRepository
    {
        ...
        public async Task<Reservation> CreateAsync(Reservation reservation)
        {
            ...
            var res = await db.DapperProcQueryAsync<ReservationEntity>("Property.Reservation_Add", new
            {
                ...
                aCleanerUserId = reservation.ArrivalCleanerUserId,
                aCleaningDate = reservation.ArrivalCleaningDate,
                aCarpetUserId = reservation.ArrivalCarpetUserId,
                aCarpetDate = reservation.ArrivalCarpetDate,
                aInspectorUserId = reservation.ArrivalInspectorUserId,
                aInspectingDate = reservation.ArrivalInspectingDate,
                dCleanerUserId = reservation.DepartureCleanerUserId,
                dCleaningDate = reservation.DepartureCleaningDate,
                dCarpetUserId = reservation.DepartureCarpetUserId,
                dCarpetDate = reservation.DepartureCarpetDate,
                dInspectorUserId = reservation.DepartureInspectorUserId,
                InspectingDate = reservation.DepartureInspectingDate,
