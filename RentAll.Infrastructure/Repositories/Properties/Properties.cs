    ...
    public partial class PropertyRepository
    {
        ...
        public async Task<Property> CreateAsync(Property property)
        {
            ...
            var res = await db.DapperProcQueryAsync<PropertyEntity>("Property.Property_Add", new
            {
                ...
                onCleanerUserId = property.OnlineCleanerUserId,
                onCleaningDate = property.OnlineCleaningDate,
                onCarpetUserId = property.OnlineCarpetUserId,
                onCarpetDate = property.OnlineCarpetDate,
                onInspectorUserId = property.OnlineInspectorUserId,
                onInspectingDate = property.OnlineInspectingDate,
                offCleanerUserId = property.OfflineCleanerUserId,
                offCleaningDate = property.OfflineCleaningDate,
                offCarpetUserId = property.OfflineCarpetUserId,
                offCarpetDate = property.OfflineCarpetDate,
                offInspectorUserId = property.OfflineInspectorUserId,
                offInspectingDate = property.OfflineInspectingDate,
