...
namespace RentAll.Infrastructure.Repositories.Properties
{
    public partial class PropertyRepository : IPropertyRepository
    {
        ...
        private static PropertyAgreement ConvertEntityToModel(PropertyAgreementEntity e) => new()
        {
            ...
            Markup = e.Markup,
            RevenueSplitOwner = e.RevenueSplitOwner ?? 0m,
        ...
        private PropertyInformation ConvertEntityToModel(PropertyInformationEntity e)
        {
            var response = new PropertyInformation()
            {
                ...
                DepartureInstructions = e.DepartureInstructions,
                DepartureCleaning = e.DepartureCleaning,
                DepartureMail = e.DepartureMail,
                DepartureFees = e.DepartureFees,
