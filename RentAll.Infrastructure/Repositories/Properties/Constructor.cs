    ...
    public partial class PropertyRepository : IPropertyRepository
    {
        ...
        private Property ConvertEntityToModel(PropertyEntity e)
        {
            var response = new Property()
            {
                ...
                Notes = e.Notes,
                OnlineCleanerUserId = e.onCleanerUserId,
                OnlineCleaningDate = e.onCleaningDate,
                OnlineCarpetUserId = e.onCarpetUserId,
                OnlineCarpetDate = e.onCarpetDate,
                OnlineInspectorUserId = e.onInspectorUserId,
                OnlineInspectingDate = e.onInspectingDate,
                OfflineCleanerUserId = e.offCleanerUserId,
                OfflineCleaningDate = e.offCleaningDate,
                OfflineCarpetUserId = e.offCarpetUserId,
                OfflineCarpetDate = e.offCarpetDate,
                OfflineInspectorUserId = e.offInspectorUserId,
                OfflineInspectingDate = e.offInspectingDate,
                IsActive = e.IsActive,
