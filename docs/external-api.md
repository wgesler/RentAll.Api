...
- Dates/times: `billingStartDate`, `billingEndDate`, `checkInTimeId` (optional, default `5` = 4PM; `0` = 11AM through `6` = 5PM), `checkOutTimeId` (optional, default `4` = 11AM; `1` = 8AM through `8` = 3PM)
