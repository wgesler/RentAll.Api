    ...
    public partial class AccountingOfficeController
    {
        ...
        public async Task<IActionResult> Delete(int officeId)
        {
            ...
            try
            {
                ...
                var existingAccountingOffice = await _officeRepository.GetAccountingByIdAsync(CurrentOrganizationId, officeId);
                ...
                await _officeRepository.DeleteAccountingAsync(CurrentOrganizationId, officeId);
                return NoContent();
            }
            catch (Exception ex)
            {
