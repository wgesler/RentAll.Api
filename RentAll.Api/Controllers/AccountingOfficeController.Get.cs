...
namespace RentAll.Api.Controllers
{
    public partial class AccountingOfficeController
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                var accountingOffices = await _officeRepository.GetAllAccountingByOfficeIdAsync(CurrentOrganizationId, CurrentOfficeAccess);
        ...
        public async Task<IActionResult> GetById(int officeId)
        {
            ...
            try
            {
                var accountingOffice = await _officeRepository.GetAccountingByIdAsync(CurrentOrganizationId, officeId);
