...
public class GetReceiptDraftsDto
{
    ...
    public (bool IsValid, string? ErrorMessage) IsValid()
    {
        ...
        if (DraftSourceFlags.HasValue && !Enum.IsDefined(typeof(ReceiptDraftSourceFlags), DraftSourceFlags.Value))
            return (false, $"Invalid DraftSourceFlags value: {DraftSourceFlags.Value}");
