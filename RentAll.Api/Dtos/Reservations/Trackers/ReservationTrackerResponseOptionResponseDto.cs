...
public class ReservationTrackerResponseOptionResponseDto
{
    ...
    public ReservationTrackerResponseOptionResponseDto(TrackerResponseOption trackerResponseOption)
    {
