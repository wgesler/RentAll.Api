...
public partial class AccountingManager
{
    public async Task<JournalEntry?> CreateJournalEntryAsync(JournalEntry journalEntry)
    {
        ...
        return await CreateJournalEntryAsync(journalEntry, requireActiveLines: true, refreshRetainedEarnings: true);
    }
    ...
    private async Task<JournalEntry?> CreateAutoGeneratedJournalEntryAsync(JournalEntry journalEntry)
    {
        ...
        return await CreateJournalEntryAsync(journalEntry, requireActiveLines: HasActiveJournalEntryLines(journalEntry), refreshRetainedEarnings: true);
    }

    private async Task<JournalEntry?> CreateJournalEntryAsync(JournalEntry journalEntry, bool requireActiveLines)
        => await CreateJournalEntryAsync(journalEntry, requireActiveLines, refreshRetainedEarnings: false);

    private async Task<JournalEntry?> CreateJournalEntryAsync(JournalEntry journalEntry, bool requireActiveLines, bool refreshRetainedEarnings)
    {
