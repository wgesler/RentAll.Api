...
public partial class AccountingManager
{
    public async Task<JournalEntry> CreateJournalEntryAsync(JournalEntry journalEntry)
        => await CreateJournalEntryAsync(journalEntry, requireActiveLines: true);

    async Task<JournalEntry> CreateAutoGeneratedJournalEntryAsync(JournalEntry journalEntry)
        => await CreateJournalEntryAsync(journalEntry, requireActiveLines: HasActiveJournalEntryLines(journalEntry));

    async Task<JournalEntry> CreateJournalEntryAsync(JournalEntry journalEntry, bool requireActiveLines)
    {
    ...
    async Task<JournalEntry> UpdateAutoGeneratedJournalEntryAsync(JournalEntry journalEntry)
        => await UpdateJournalEntryAsync(journalEntry, requireActiveLines: HasActiveJournalEntryLines(journalEntry));

    async Task<JournalEntry> UpdateJournalEntryAsync(JournalEntry journalEntry, bool requireActiveLines)
    {
    ...
    static bool HasActiveJournalEntryLines(JournalEntry journalEntry)
