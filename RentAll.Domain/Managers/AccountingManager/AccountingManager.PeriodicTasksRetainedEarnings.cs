...
public partial class AccountingManager
{
    ...
    private async Task CreateJournalEntryForRetainedEarningsAsync(Guid organizationId, AccountingOffice accountingOffice, DateOnly processingDate, CancellationToken cancellationToken, bool logDecisions = false)
    {
        ...
        foreach (var (fiscalYearStart, fiscalYearEnd) in fiscalYearsToClose)
        {
            ...
            await SaveRetainedEarningsJournalEntryAsync(
                organizationId,
                accountingOffice,
                chartOfAccounts,
                profitLossAccounts,
        ...
        bool logDecisions)
    {
        ...
        await UpdateRetainedEarningsJournalEntryAsync(
            organizationId,
            accountingOffice,
            chartOfAccounts,
            profitLossAccounts,
        ...
        DateOnly processingDate)
    {
        await LogRetainedEarningsJournalEntryLinesAsync(
            ...
            netIncome,
            accountYearBalances,
            "Retained earnings journal entry before create");
        ...
        catch (Exception ex)
        {
            await LogRetainedEarningsJournalEntryLinesAsync(
                ...
                netIncome,
                accountYearBalances,
                $"Retained earnings journal entry create failed: {ex.Message}");
            throw;
        }
    }
        ...
        DateOnly processingDate)
    {
        await LogRetainedEarningsJournalEntryLinesAsync(
            ...
            netIncome,
            accountYearBalances,
            "Retained earnings journal entry before update");
        ...
        catch (Exception ex)
        {
            await LogRetainedEarningsJournalEntryLinesAsync(
                ...
                netIncome,
                accountYearBalances,
                $"Retained earnings journal entry update failed: {ex.Message}");
            throw;
        }
    }
