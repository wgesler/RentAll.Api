...
public partial class AccountingManager
{
    ...
    private async Task<AccountingJournalEntryResult> CreateJournalEntryFromTransferWithResultAsync(Transfer transfer, Guid currentUser)
    {
        ...
        try
        {
            ...
            var created = await CreateAutoGeneratedJournalEntryAsync(journalEntry, postImmediately: true);
            if (created == null)
                return AccountingJournalEntryResult.Success();
    ...
    private async Task TryReplaceJournalEntriesFromTransferAsync(Transfer transfer, Guid currentUser)
    {
        try
        {
            ...
            if (existingEntry != null)
            {
                ...
                await UpdateAutoGeneratedJournalEntryAsync(rebuiltJournalEntry, postImmediately: true);
            ...
            var createdJournalEntry = await CreateAutoGeneratedJournalEntryAsync(rebuiltJournalEntry, postImmediately: true);
