...
public partial class AccountingManager
{
    ...
    private async Task<AccountingJournalEntryResult> CreateJournalEntryFromTransferWithResultAsync(Transfer transfer, Guid currentUser)
    {
        ...
        try
        {
            ...
            var journalEntry = BuildJournalEntryFromTransferRecord(transfer, currentUser);
    ...
    private async Task TryReplaceJournalEntriesFromTransferAsync(Transfer transfer, Guid currentUser)
    {
        try
        {
            ...
            var rebuiltJournalEntry = BuildJournalEntryFromTransferRecord(transfer, currentUser);
    ...
    private static void ValidateTransferForJournalEntry(Transfer transfer)
    {
        ...
        if (transfer.BankAccountId is null or <= 0)
    ...
    private JournalEntry BuildJournalEntryFromTransferRecord(Transfer transfer, Guid currentUser)
    {
        ...
        var journalEntryLines = new List<JournalEntryLine>
        {
            new()
            {
                ChartOfAccountId = transfer.BankAccountId!.Value,
