...
public partial class AccountingManager
{
    private async Task TryReplaceJournalEntriesFromWorkOrderAsync(WorkOrder workOrder, Guid currentUser)
    {
        try
        {
            ...
            await PruneOpenDuplicateAutoGeneratedJournalEntriesAsync(existingEntries, workOrder.OrganizationId);
    ...
    private async Task ReplaceJournalEntriesFromReceiptAsync(Receipt receipt, Guid currentUser)
    {
        try
        {
            ...
            await PruneOpenDuplicateAutoGeneratedJournalEntriesAsync(existingEntries, receipt.OrganizationId);
