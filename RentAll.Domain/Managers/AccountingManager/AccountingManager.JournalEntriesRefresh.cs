...
public partial class AccountingManager
{
    ...
    private async Task RemoveAutoGeneratedJournalEntryForDocumentSyncAsync(JournalEntry entry, Guid organizationId, JournalEntry? rebuiltReplacement, Guid currentUser)
    {
