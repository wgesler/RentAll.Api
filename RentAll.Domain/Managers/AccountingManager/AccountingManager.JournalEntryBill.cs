        ...
        try
        {
            ...
            try
            {
                ...
                if (ownerUtilityJournalEntry != null)
                {
                    ...
                    var tenantOverageAmount = await CalculateTenantOverageAmountAsync(bill, ownerUtilityJournalEntry);
                    if (HasTenantOverage(tenantOverageAmount))
                    {
                        var tenantOverageJournalEntry = BuildTenantOverageJournalEntryFromBill(
                            bill,
                            ownerUtilityJournalEntry,
                            tenantOverageAmount,
                            chartOfAccounts,
                            accountingOffice,
                            currentUser);
                        await CreateAutoGeneratedJournalEntryAsync(tenantOverageJournalEntry);
                    }
                }
            }
