...
public partial class AccountingManager
{
    ...
    private async Task<AccountingJournalEntryResult> CreateJournalEntryFromPaymentWithResultAsync(Invoice invoice, LedgerLine paymentLedgerLine, Guid currentUser)
    {
        ...
        try
        {
            ...
            {
                var paymentJournalEntry = await BuildJournalEntryFromPaymentAsync(invoice, paymentLedgerLine, chartOfAccounts, accountingOffice, currentUser);
    ...
    private async Task<JournalEntry> BuildJournalEntryFromInvoiceAsync(Invoice invoice, List<ChartOfAccount> chartOfAccounts, AccountingOffice? accountingOffice, Guid currentUser, Guid? sourceIdOverride = null)
    {
        ...
        var invoiceMemo = (invoice.InvoiceCode ?? string.Empty).Trim();
