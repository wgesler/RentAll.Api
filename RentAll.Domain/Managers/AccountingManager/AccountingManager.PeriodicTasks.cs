...
public partial class AccountingManager
{
    ...
    private Task BuildAnnualJournalEntriesForLinensAndTowelsAsync(Guid organizationId, PropertyAgreement agreement, DateOnly? availableFrom, DateOnly? availableUntil, DateOnly processingDate, CancellationToken cancellationToken)
    {
        cancellationToken.ThrowIfCancellationRequested();
        ...
        return BuildLinenAndTowelEntriesAsync(organizationId, agreement, availableFrom, availableUntil, isMonthly: false, processingDate, cancellationToken);
    }
