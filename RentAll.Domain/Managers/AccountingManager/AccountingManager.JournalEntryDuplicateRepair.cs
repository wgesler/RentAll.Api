...
public partial class AccountingManager
{
    ...
    private async Task PruneDuplicateOpenInvoicePaymentJournalEntriesByPaymentIdAsync(
        Guid paymentId,
        Guid organizationId,
        Guid currentUser)
    {
        ...
        var entries = (await GetJournalEntriesByPaymentIdCachedAsync(organizationId, paymentId))
        ...
        await PruneOpenDuplicateAutoGeneratedJournalEntriesAsync(entries, organizationId, currentUser);
    }
}
