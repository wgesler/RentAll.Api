        ...
        AccountingSyncBailTrail trail)
    {
        ...
        try
        {
            ...
            while (existingEntries.Count > 1)
            {
                ...
                trail.Note($"Deleting duplicate deposit JE {duplicate.JournalEntryCode}");
            ...
            if (existingEntry != null)
            {
                ...
                trail.Note($"Updated existing deposit JE {existingEntry.JournalEntryCode}");
                await SyncDepositDocumentLinksAsync(deposit, currentUser);
                trail.Note("SyncDepositDocumentLinksAsync completed.");
                return;
            }
            ...
            trail.Note($"Created deposit JE {created.JournalEntryCode}");
            await SyncDepositDocumentLinksAsync(deposit, currentUser);
            trail.Note("SyncDepositDocumentLinksAsync completed.");
        }
        catch (Exception ex)
