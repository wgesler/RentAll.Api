...
public interface IReportManager
{
    ...
    Task<CloseOwnerStatementMonthResult> CloseOwnerStatementMonthAsync(Guid organizationId, DateOnly? startDate, DateOnly endDate, IReadOnlyList<OwnerStatementMonthCloseLine> lines, Guid currentUser);
