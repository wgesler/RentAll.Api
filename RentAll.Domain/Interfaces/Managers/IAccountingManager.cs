...
public interface IAccountingManager
{
    ...
    Task<CloseOwnerStatementMonthResult> CloseOwnerStatementMonthAsync(Guid organizationId, string officeIds, DateOnly endDate, IReadOnlyList<OwnerCashReportRow> rows, Guid currentUser);
