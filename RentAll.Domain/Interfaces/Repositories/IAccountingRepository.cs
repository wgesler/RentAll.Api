...
public interface IAccountingRepository
{
    ...
    #region Get
    Task<IEnumerable<Payment>> GetPaymentsByOfficeIdsAsync(Guid organizationId, string officeAccess, int paymentKindId);
    ...
    Task<IReadOnlyList<PaymentOwnerAllocation>> GetOwnerAllocationsByPaymentIdAsync(Guid paymentId, Guid organizationId);
