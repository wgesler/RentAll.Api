...
public interface IReservationRepository
{
    ...
    Task<IEnumerable<ReservationDeparture>> GetMonthlyDepartedReservationsAsync(Guid organizationId, string officeAccess, DateOnly? startDate = null, DateOnly? endDate = null);
