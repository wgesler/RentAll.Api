...
public class InvoiceJournalEntryGapCoverageTests
{
    ...
    [Fact]
    public async Task CrossPeriodWithFees_FebInvoice_FallsBackToSingleJeThatBalancesFullInvoice()
    {
        ...
        Assert.Contains(invoice.LedgerLines, line => line.Description == "Security Deposit");
        Assert.Contains(invoice.LedgerLines, line => line.Description == "Pet Fee");
        Assert.Contains(invoice.LedgerLines, line => line.Description.StartsWith("Maid Service"));
    }
